  ...
  return (
    <div className="">
      <div className="bg-emerald-500 rounded-xl p-6 text-center mb-4">
        <h1 className="text-4xl font-bold text-yellow-300 pb-6">Bienvenue sur EASY-MEMBERSHYP</h1>
        <p className="text-white"><span className="font-bold text-yellow-300">Easy-membershyp</span> votre partenaire pour gére vos tontines de maniere efficace et professionnel</p>
      </div>
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="bg-indigo-500 p-4 rounded-xl shadow">
          ...
          <h2 className="text-yellow-300 text-2xl font-bold">350 000 FCFA</h2>
        </div>
